...
const portfolioImages = [
	{
		src: '/images/IMG_2162.jpg',
		alt: 'Hair design work - long wavy brown hair with golden highlights',
	},
	{
		src: '/images/IMG_2112.jpeg',
		alt: 'Hair design work - blonde balayage with natural waves',
	},
	{
		src: '/images/IMG_2117.jpg',
		alt: 'Hair design work - creative color with purple and blonde',
	},
	{
		src: '/images/IMG_2120.jpg',
		alt: 'Hair design work - voluminous blonde waves',
	},
	{
		src: '/images/IMG_2122.jpg',
		alt: 'Hair design work - layered blonde with natural texture',
	},
	{
		src: '/images/IMG_2164.jpg',
		alt: 'Hair design work - ombré with pink-blonde tones',
	},
]
		...
		>
			<div className='mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12'>
				<div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start'>
					{/* Portfolio Gallery - Left side (optimized responsive images) */}
						...
						<GlassSection isVisible={isApproachVisible} position='right'>
							...
							<div className='prose prose-lg max-w-none'>
								<p className='text-zinc-700 mb-4 text-left'>
									The studio&apos;s founder is{' '}
									<span className='font-semibold'>Yuriy</span>.
								</p>
								<p className='text-zinc-700 mb-4 text-left'>
									He has many years of experience working with and teaching
									students, and is also the creator of the courses{' '}
									<span className='italic'>&quot;The Art of Shape&quot;</span>{' '}
									and{' '}
									<span className='italic'>&quot;The Art of Color&quot;</span>.
								</p>
								<p className='text-zinc-600 text-left'>
									Our approach combines technique, observation, and a sense of
									measure. The goal is not to change nature, but to gently
							...
							>
								...
								<div className='prose prose-lg max-w-none'>
									...
									<p className='text-zinc-700 mb-4 text-left'>
										...
										<br />
										to relax, feel cared for, and achieve results without rush
										or pressure.
									</p>
									<p className='text-zinc-600 text-left'>
										There are no templates or imposed solutions here. Every look
